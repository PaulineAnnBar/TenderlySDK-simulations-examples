...
var isTenderlyAxiosError = /* @__PURE__ */ __name((error) => {
  var _a, _b, _c;
  return (0, import_axios.isAxiosError)(error) && !!(((_b = (_a = error == null ? void 0 : error.response) == null ? void 0 : _a.data) == null ? void 0 : _b.error) && ((_c = error == null ? void 0 : error.response) == null ? void 0 : _c.status));
...
var ApiClient = class {
  ...
  */
  constructor({ apiKey, version = "v1" }) {
    ...
    this.api = import_axios2.default.create({
